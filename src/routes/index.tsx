    ...
    <div className="relative min-h-dvh overflow-hidden bg-background">
      ...
      <div className="relative mx-auto min-h-dvh max-w-[1500px] px-4 py-5 sm:px-6 lg:px-8">
        ...
        <main className="mt-4 grid gap-4 lg:grid-cols-[0.82fr_1.2fr_1fr]">
          ...
          <section className="relative rounded-[2rem] border-[6px] border-slate-950 bg-background p-3 shadow-2xl ring-1 ring-border-strong sm:p-4 2xl:mx-24">
            <PreviewPhone
              title="Community"
              className="absolute right-[calc(100%-1rem)] top-10 hidden w-52 -rotate-2 2xl:block"
            />
            <PreviewPhone
              title="Events"
              className="absolute left-[calc(100%-1rem)] top-8 hidden w-52 rotate-2 2xl:block"
            />
